...
def messagesForEveryone(session, uid, type, text, sent_time, ignore_level):
...
def accountCommands(session, uid, type, text, sent_time, ignore_level):
    text = text.strip()
...
ekg.handler_bind('protocol-message-received', messagesForEveryone)
ekg.handler_bind('protocol-message-received', accountCommands)
